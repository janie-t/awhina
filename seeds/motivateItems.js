  ...
  return knex('motivate').del()
    .then(function () {
      return Promise.all([
        ...
        knex('motivate').insert({motivate_id: 4, motivate_item: 'https://www.youtube.com/embed/H14bBuluwB8', motivate_source: 'Angela Lee Duckworth - Psychologist', motivate_type: 'video'}),
        ...
        knex('motivate').insert({motivate_id: 7, motivate_item: 'https://www.youtube.com/embed/MKXjjpZqZwU', motivate_source: 'Steve Wozniak - Co-founder Apple ', motivate_type: 'video'}),
        ...
        knex('motivate').insert({motivate_id: 14, motivate_item: 'https://www.youtube.com/embed/FLbXrNGVXfE', motivate_source: 'Sir Ken Robinson - Education researcher', motivate_type: 'video'}),
